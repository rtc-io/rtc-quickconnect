...
var BROWSER_SUPPORT = {
    ...
    'ios': {
        '12.1.1': [UNIFIED_PLAN, PLAN_B], // 12.1.1 problem 12.3 iphone
        '12.1.0': [PLAN_B, UNIFIED_PLAN], // 12.xxx
        '11.0': [PLAN_B]
    },
    'safari': {
        '12.1.1': [UNIFIED_PLAN, PLAN_B],
        '12.1.0': [PLAN_B, UNIFIED_PLAN], // currently, worked one
        '11.0': [PLAN_B]
    }
};
